...
logFile_checkJoints = f"{'pd-'}{file_number_ch}{extension}"
...
with open(logFile_checkJoints, 'w', newline='') as csvfile_check:
    ...
    while( cnt < 2000 ):
        ...
        p.setJointMotorControlArray(robot_id, check_joints, p.VELOCITY_CONTROL, forces = row_torq)
