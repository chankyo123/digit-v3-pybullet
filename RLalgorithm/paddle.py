...
class Paddle(): 
    ...
    def reset(self):
        ...
        self.ball.goto(0, 100)
        # choice = [-1,1]
        # dx = random.choice(choice)
        # print(dx)
        return np.array([self.paddle.xcor()*0.01, self.ball.xcor()*0.01, self.ball.ycor()*0.01, self.ball.dx, self.ball.dy])
        # return np.array([self.paddle.xcor()*0.01, self.ball.xcor()*0.01, self.ball.ycor()*0.01, dx, self.ball.dy])
    ...
    def step(self, action):
        ...
        state = np.array([self.paddle.xcor()*0.01, self.ball.xcor()*0.01, self.ball.ycor()*0.01, self.ball.dx, self.ball.dy])
