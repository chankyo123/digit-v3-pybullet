...
# robot_id = p.loadURDF("/Users/ckkim/Chankyo Kim/Michigan/pybullet/urdf/digit-v3.urdf",[0,0,1.5],[0,0,0,1],useFixedBase = True)
# robot_id = p.loadURDF("/Users/ckkim/Chankyo Kim/Michigan/pybullet/urdf/digit-v3/digit-v3-armfixed.urdf", [0,0,1.5],[0,0,0,1], useFixedBase = True) 
# robot_id = p.loadURDF("/Users/ckkim/Chankyo Kim/Michigan/pybullet/urdf/digit-v3/digit-v3-armfixed-zeromotor.urdf", [0,0,1.5],[0,0,0,1], useFixedBase = True) 
...
# robot_id = p.loadURDF("/Users/ckkim/Chankyo Kim/Michigan/pybullet/urdf/digit-v3/digit-v3-armfixed-left.urdf", [0,0,1.5],[0,0,0,1], useFixedBase = True) 
...
# gP=[b, b, b, b, b, b, a, a, a, a, a, a]; gV=[b, b, b, b, b, b, a, a, a, a, a, a]
gP=[a for i in range(len(desiredPosition))]; gV=[a for i in range(len(desiredPosition))]
